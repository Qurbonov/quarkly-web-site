...
import { Theme, Link, Text, Box, Structure, Image, Hr } from "@quarkly/widgets";
...
export default (() => {
	return <Theme theme={theme}>
		...
		<Structure cells-number-total="6" cells-number-group="3" padding="50px 0px 150px 0px">
			<Override slot="Content" grid-template-columns="1fr 1fr 3fr" sm-grid-template-columns="1fr" sm-grid-gap="8px">
				<Override slot="cell-0">
				...
				<Override slot="Cell 0th" width="100%" />
				<Override slot="Cell" justify-self="center" sm-justify-self="auto" />
				<Override slot="Cell 2" margin="0px 0px 80px 0px" />
				<Override slot="Cell 1" margin="0px 0px 80px 0px" sm-margin="0px 0px 0px 0px" />
				<Override slot="Cell 0" margin="0px 0px 80px 0px" sm-margin="0px 0px 0px 0px" />
			</Override>
		</Structure>
